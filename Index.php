	...
	<div id="wrapper">
        ...
        <div id="menu_content">
        	<div id="menu_content_left">
        		<?php 
                    $query = mysqli_query($mysqli ,"SELECT * FROM kategorisoal WHERE type LIKE'%SLTP%' OR type LIKE'%SLTA%' OR type LIKE'%SBMPTN%' OR type LIKE'%UM%' ORDER BY waktu DESC limit 10");
